...
from ylla_consulting.mixins import NextUrlMixin, RequestFormAttachMixin
...
class AccountEmailActivateView(FormMixin,View):
    ...
    def get(self, request, key=None, *args, **kwargs):
        ...
        if key is not None:
            ...
            if confirm_qs.count() == 1:
                ...
                obj.activate()
                messages.success(request, _("Votre adresse émail a été confirmé avec succès. Vous pouvez vous connecté en toute sécurité"))
    ...
    def form_valid(self, form):
        msg = _(""" Lien d'activation a été envoyé, Veillez vérifier votre boite mail. N'hésitez pas à vérifier vos spam on ne sait jamais""")
...
def register(request):
    ...
    if form.is_valid() and phone_input and terms_check is not None:
        instance = form.save(commit=False)
        instance.mobile= phone_input
        instance.save()
